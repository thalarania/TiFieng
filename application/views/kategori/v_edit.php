						...
						<form action="<?php echo base_url() ?>kategori/update" method="post">
                            <div class="card-body">
								...
								<div class="form-group">
									<input type="hidden" class="form-control" id="id_kategori" name="id_kategori" value="<?= $detail ['id_kategori']?>">
								</div>
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $detail['nama_kategori'] ?>">
                                </div>

								<div class="form-group">
                                    <label for="exampleInputEmail1">Nama Teknisi</label>
                                    <input type="text" class="form-control" id="nama_teknisi" name="nama_teknisi" value="<?= $detail['nama_teknisi'] ?>">
                                </div>
